...
public class AccountManagerImpl implements AccountManager {
    ...
    public List<String> readingFile() throws IOException {
        ...
        try(BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\eliza\\IdeaProjects\\java_lesson4\\src\\accounts.csv"))){
            String line;
    ...
    public void writingFile(List<String> persons, boolean append) throws IOException {
        try(BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\eliza\\IdeaProjects\\java_lesson4\\src\\accounts.csv", append))){
    ...
    public void registerNewAccount(String email, String password, Person person) throws DuplicateAccountException, IOException {
        ...
        for (String line : readingFile()){
            if (line.split(", ")[0].equals(person.getName())) {
                throw new DuplicateAccountException("Error: the account already exists.");
            }
        }
    ...
    public void removeAccount(String email, String password) throws WrongCredentialsException, IOException {
        ...
        if (control == null){
            throw new WrongCredentialsException("Error: data is not correct.");
        }

        System.out.println("Account " + control.split(", ")[0] + " is deleted successful");
    }
    ...
    public Person getPerson(String email, String password) throws TooManyLoginAttemptsException, IOException, WrongCredentialsException {
        ...
        if (person == null){
            throw new WrongCredentialsException("Error: data is not correct. Attempt number: " + counter.Counter());
